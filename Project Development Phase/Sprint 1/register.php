<?php
 ...
 $mail->Username = 'damagedetectionanalysis@gmail.com'; //SMTP username
 $mail->Password = 'sgmdgfpxacgtinlv'; //SMTP password
 $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS; //Enable implicit TLS encryption
 $mail->Port = 465; //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`
 //Recipients
 $mail->setFrom('damagedetectionanalysis@gmail.com');
 $mail->addAddress($email);
 //Content
 $mail->isHTML(true); //Set email format to HTML
 $mail->Subject = 'DAMAGE DETECTION';
 $mail->Body = 'Here is the verification link <b><a href="http://localhost/login1/?verification='.$code.'"> Link </a></b>';
 $mail->send();
